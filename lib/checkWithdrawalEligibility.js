	...
	return new Promise(async (resolve, reject) => {
		try {
			...
			if (referencedClaimedPrs.length !== 0) {
				...
				return reject(ONGOING_ALREADY_CLAIMED({ issueUrl, payoutAddress: '0x1abc0D6fb0d5A374027ce98Bf15716A3Ee31e580', claimant: viewer, claimantAsset: referencedClaimedPrs[0] }));
			}
